...
static unsafe partial class NativeEntryPoint
{
        ...
        string hostfxrPath, string[] args)
    {
        ...
        TelemetryClient = new TelemetryClient(sessionId: null);
        DateTime postTelemetry = DateTime.UtcNow;
        var mainActivity = Activities.Source.StartActivity("native-entrypoint", Telemetry.TelemetryClient.ActivityKind, Telemetry.TelemetryClient.ParentActivityContext);
